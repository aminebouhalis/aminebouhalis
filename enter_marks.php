...
$studentsQuery = $conn->prepare("
    SELECT s.registerNumber, s.fullName 
    FROM students s
...
<head>
    ...
    <style>
        ...
        .module-name { text-align: center; font-size: 1.2em; margin-bottom: 20px; color: #3498db; }
        ...
        button { background-color: #2ecc71; color: white; border: none; padding: 10px; margin-top: 20px; cursor: pointer; border-radius: 4px; width: 100%; }
